...
import com.dalftech.rydegorider.Helper.SharedHelper;
...
import static com.dalftech.rydegorider.RydeGoDriverApplication.trimMessage;
    ...
    public void getProviderSummary() {
        {
            ...
            RydeGoDriverApplication.getInstance().addToRequestQueue(jsonObjectRequest);
        }
    }
